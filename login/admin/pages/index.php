    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <div class="navbar-default sidebar" role="navigation">
                ...
                ?>
                        <li>
                            <a href="?page=home"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="?page=data_barang">Data Barang</a>
                                </li>
                                <li>
                                    <a href="?page=data_member">Data Member</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="?page=laporan_member">Laporan Member</a>
                                </li>
                                <li>
                                    <a href="?page=laporan_barang">Laporan Barang</a>
                                </li>
                                <li>
                ...
                ?>
                        ...
                        <li>
                            <a href="?page=data_penjualan"><i class="fa fa-shopping-cart"></i> Data Penjualan</a>
                        </li>
                <?php } ?>
